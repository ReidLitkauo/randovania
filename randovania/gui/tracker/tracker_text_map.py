...
class TrackerTextMap(TrackerComponent):
    ...
    def __init__(self, logic: Logic):
        ...
        self.resource_filter_check.setText(_t("TrackerWindow", u"Show only resources", None))
        self.hide_collected_resources_check.setText(_t("TrackerWindow", u"Hide collected resources", None))
        ___qtreewidgetitem = self.possible_locations_tree.headerItem()
        ___qtreewidgetitem.setText(0, _t("TrackerWindow", u"Accessible Locations", None))
